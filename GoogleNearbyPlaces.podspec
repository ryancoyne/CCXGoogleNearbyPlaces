#
#  Be sure to run `pod spec lint GoogleNearbyPlaces.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = '2.0.0'
  s.summary  = 'GoogleNearbyPlaces is a wrapper around the Google Places API.  All you do is set your API Key and you are good to go!'
  ...
  # s.authors            = { "Ryan Coyne" => "email@address.com" }
